...
def merger_history(
    ...
    tree = loadTree(
        basePath=BasePath, snapNum=snap, id=subID, fields=allfields, onlyMPB=False
    )
    ...
    if numMergers > 0:
        ...
        F_scalefactor = [
            loadHeader(BasePath, i)['Time'] for i in MergerHistory['First-SnapNum']
        ]
        N_scalefactor = [
            loadHeader(BasePath, i)['Time'] for i in MergerHistory['Next-SnapNum']
        ]
            ...
            for i in units_strlist:
                if 'h' in i:
                    ...
                    if len(h_strlist) == 1:
                        ...
                        if '/' in h_strlist[1]:
                            h_pow = float(h_strlist[1].split('/')[0]) / float(
                                h_strlist[1].split('/')[1]
                            )
                        else:
            ...
            for i in units_strlist:
                if 'a' in i:
                    ...
                    if len(a_strlist) == 1:
                        ...
                        if '/' in a_strlist[1]:
                            a_pow = float(a_strlist[1].split('/')[0]) / float(
                                a_strlist[1].split('/')[1]
                            )
                        else:
